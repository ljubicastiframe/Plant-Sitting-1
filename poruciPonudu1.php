...
<div class="forma_porucivanja">
    <h2>Porucite uslugu 1</h2>
    <form name="order" method="post" action="/potvrda1.php">
        ...
        <span> Cena: 200din/dan </span> <br>
        <div>
            <button class="button" onclick="location.href='/potvrda1.php';" type="submit"> Poruci </button>
        </div>
    </form>
