...
<div class="forma_porucivanja">
    <h2>Porucite uslugu 2</h2>
    <form name="order" method="post" action="/potvrda2.php">
        ...
        <span> Cena: 300din/dan </span> <br>
        <div>
            <button class="button" onclick="location.href='/potvrda2.php';" type="submit"> Poruci </button>
        </div>
    </form>
