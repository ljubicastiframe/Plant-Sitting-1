...
<div class="forma_porucivanja">
    <h2>Porucite uslugu 4</h2>
    <form name="order" method="post" action="/potvrda4.php">
        ...
        <span> Cena: 1000din/dan </span> <br>
        <div>
            <button class="button" onclick="location.href='/potvrda4.php';" type="submit"> Poruci </button>
        </div>
    </form>
